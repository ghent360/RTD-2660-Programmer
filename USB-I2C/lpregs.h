...
//
// $Archive: /USB/Target/Inc/lpregs.h $
// $Date: 9/03/03 2:26p $
// $Revision: 4 $
//
//
...
#ifndef LPREGS_H   /* Header Sentry */
#define LPREGS_H

//-----------------------------------------------------------------------------
// FX2LP/FX1 Related Register Assignments
//-----------------------------------------------------------------------------
...
// Error Correction Code (ECC) Registers
...
// Feature Registers
EXTERN xdata volatile BYTE GPCR2             _AT_ 0xE509;  // Chip Features
...
#define bmHIGHSPEEDCAPABLE    bmBIT4
